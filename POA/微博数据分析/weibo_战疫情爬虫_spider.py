...
def spider_title(comment_ID):
    try:
        ...
        elif 'Sept' in created_title_time:
...
def write_csv(jsondata):
    for json in jsondata['data']['data']:
        ...
        if 'Feb' in created_times:
            ...
            created_YMD = "{}/{}/{}".format(created_times[-1], '06', created_times[2])
        elif 'Jul' in created_times:
            created_YMD = "{}/{}/{}".format(created_times[-1], '07', created_times[2])
        elif 'Aug' in created_times:
            created_YMD = "{}/{}/{}".format(created_times[-1], '08', created_times[2])
        elif 'Sept' in created_times:
            created_YMD = "{}/{}/{}".format(created_times[-1], '09', created_times[2])
